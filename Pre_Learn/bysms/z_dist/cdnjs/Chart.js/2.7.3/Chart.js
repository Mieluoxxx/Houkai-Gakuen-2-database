...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit project based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-project at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-project at the current y coordinate
